...
export default function Header(){
    return(
        <div className="container-fluid flex flex-row justify-between content-center w-full mx-[0.68em]">
            <span className="text-sm text-white font -bold uppercase m-0 leading-3">Mark<br/>Kirby</span>
